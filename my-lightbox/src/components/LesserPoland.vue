  ...
  <ul>
    <li style="list-style-type: none;">
      <a href="https://kaleta.toadres.pl/assets/2021_02_12_16h50_2.04MB-d4714a20.jpg" class="glightbox">
        <div class="img__wrap">
          <img class="img__img" style="height: 300px;" src="@/assets/lesser_poland/2021_02_12_12h50_2.77MB.jpg" alt="image" />
    ...
    <li style="list-style-type: none;">
      <a href="https://kaleta.toadres.pl/assets/2021_02_12_11h41_4.93MB-8530b62f.jpg" class="glightbox">
        <div class="img__wrap">
          <img class="img__img" style="height: 300px;" src="@/assets/lesser_poland/2021_02_12_16h53_1.76MB.jpg" alt="image" />
          <p class="img__description">Tenczyn castle in Rudno</p>
        </div>
      </a>
    </li>
    ...
    <li style="list-style-type: none;">
      <a href="https://kaleta.toadres.pl/assets/2021_02_14_16h33_2.33MB-a1613de8.jpg" class="glightbox">
        <div class="img__wrap">
          <img class="img__img" style="height: 300px;" src="@/assets/lesser_poland/2021_02_14_10h59_1.91MB.jpgg" alt="image" />
          <p class="img__description">Tenczyn castle in Rudno</p>
        </div>
      </a>
    </li>
    ...
    <li style="list-style-type: none;">
      <a href="https://kaleta.toadres.pl/assets/2021_02_13_15h25_3.95MB-97db6230.jpg" class="glightbox">
        <div class="img__wrap">
          <img class="img__img" style="height: 300px;" src="@/assets/lesser_poland/2022_08_14_09h52_2.43MB.jpg" alt="image" />
          <p class="img__description">Tenczyn castle in Rudno</p>
        </div>
      </a>
    </li>
